...
**/
package com.project_study.my.ocr.ocr;
...
public class HWOcrClientToken {
	...
	private  String regionName;  //region for com.project_study.my.ocr.ocr service(cn-north-1,cn-south-1 etc.)
	 ...
	 * @param region   region for com.project_study.my.ocr.ocr service(cn-north-1,cn-south-1 etc.)
	...
	public HWOcrClientToken(String domain,String usrname,String password,String region) {
		...
		regionName=region;
		token="";
		httpEndpoint="com.project_study.my.ocr.ocr." + region +".myhuaweicloud.com";;
